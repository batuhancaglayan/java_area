package com.aws.sdk.tryer.lambda.custom.module;
...
public class DenemeHandler implements RequestHandler<Map<String, Object>, Object> {
...
//		logger.log((String)input.get("ResourceProperties"));
